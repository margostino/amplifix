...
help:
	...
	@echo  ''
	@echo  'Usage:'
	@echo  '  start-spring 	                - Create demo container and spin up all environments (Spring Demo 2 instances, Grafana, Prometheus and Hazelcast)'
	@echo  '  start-vertx 	                - Create demo container and spin up all environments (Vertx Demo 2 instances, Grafana, Prometheus and Hazelcast)'
	@echo  '  run                           - Spin up all environments (Demo 2 instances, Grafana, Prometheus and Hazelcast). Note: the container amplifix-demo:latest is expected in place'
	@echo  '  build-toolkit                 - Build tolkit JAR and put it in libs folder in both demos projects'
	@echo  '  build-spring 	                - Build Spring Demo'
	@echo  '  build-vertx 	                - Build Vertx Demo'
	@echo  '  generate-flow max=5 port=5000 - Generate traffic given a max number of request '
	@echo  ''
