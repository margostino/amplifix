...
**IMPORTANT:** This project is an experiment and it is in continuous progress, adding, changing features and evaluating performance and new functionalities. Once this toolkit is stable, the firt version will be properly relesed and documented. So it should not be used in Production environments.
